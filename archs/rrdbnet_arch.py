# Rakotonirina, N.C. and Rasoanaivo, A., 2020, May. ESRGAN+: Further improving enhanced super-resolution generative adversarial network. In ICASSP 2020-2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) (pp. 3637-3641). IEEE.
# https://arxiv.org/abs/2001.08073
# licenses/ESRGANplus_LICENSE
# https://github.com/ncarraz/ESRGANplus/blob/master/codes/models/modules/architecture.py
# https://github.com/ncarraz/ESRGANplus/blob/master/codes/models/modules/block.py
...
class RRDB(nn.Module):
    ...
    def forward(self, x):
        ...
        out = torch.utils.checkpoint.checkpoint(self.RDB1, x, use_reentrant=False)
        out = torch.utils.checkpoint.checkpoint(self.RDB2, out, use_reentrant=False)
        out = torch.utils.checkpoint.checkpoint(self.RDB3, out, use_reentrant=False)
...
class RRDBNet(nn.Module):
    def __init__(self, in_nc, out_nc, nf, nb, gc=32, upscale=4, norm_type=None, \
            plus=False, act_type='leakyrelu', mode='CNA', upsample_mode='upconv'):
